...
public class PaidTabFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.tvListHeaderTitle)).setText("Completed & Paid Loans");
    ...
    private void loadPaid() {
        Request request = new Request.Builder()
                .url("https://uzidohuwcebfoovydyak.supabase.co/rest/v1/loans?is_paid=eq.1&order=id.desc")
                    ...
                    requireActivity().runOnUiThread(() -> {
                        ...
                        rv.setAdapter(new RecyclerView.Adapter<RecordVH>() {
                            ...
                            @Override public void onBindViewHolder(@NonNull RecordVH holder, int position) {
                                ...
                                holder.t1.setText(l.get("phone") + " | Fully Repaid: ₹" + (int)total);
                                holder.t2.setText("Closed on Due Date: " + l.get("due_date"));
                            }
